 ...
 */
class DiffAdapter(private val repositoryCommit: RepositoryCommit, private val listener: DiffAdapter.Listener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
